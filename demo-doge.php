...
<script type="text/javascript">
	...
	jQuery(document).ready(function(){
		...
		var getaddress = $.ajax( '/models/get_address.php' + '?user=' + 2 + '&type=doge' );
			  getaddress.done(function(data) {
			  	address = getAddress2(data);
			  	//clear any stacked payments
			  	var clear = $.ajax( '/models/verify.php' + '?address=' + address + '&user=' + 2 );
    ...
    $('.btnkey').click(function(event){
		...
		jQuery('#dollars').keyup(function(){
			...
			var tempconversion = $.ajax( '/models/get_doge_conversion.php' + '?amount=' + amount + '&currency=USD')
				  .done(function(data) {
		...
		jQuery('#submit').click(function(event){ //fetch search results whenever a key is pressed
              ...
              var conversion = $.ajax( '/models/get_doge_conversion.php' + '?amount=' + amount + '&currency=USD' )
				  .done(function(data) {
			  ...
			  function autoUpdate(){
			    ...
			    var payment = $.ajax( '/models/verify.php' + '?address=' + address + '&user=' + 2 );
