...
<p>
<label>Message:</label>
<input type='text' name='settings[".$settings['message']['id']."]' value='".$message."' />
</label>
</p>
<p>
<label>Message Type:</label>
<select name='settings[".$settings['message_type']['id']."]' >
<option value='warning'"; if ($messageType == 'warning'){echo "selected='selected'";} echo ">warning</option>";
echo "<option value='info'"; if ($messageType == 'info'){echo "selected='selected'";} echo ">info</option>";
echo "<option value='disabled'"; if ($messageType == 'disabled'){echo "selected='selected'";} echo ">disabled</option>";
